  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        "vf4-blue": "hsl(var(--vf4-blue))",
        "vf4-dark": "hsl(var(--vf4-dark))",
        sidebar: {
      ...
      animation: {
        ...
        "crash-grow": "crash-grow 0.5s ease-out",
        "coin-flip": "coin-flip 2s ease-out",
        "dice-roll": "dice-roll 1s ease-out",
        "penalty-kick": "penalty-kick 0.8s ease-out forwards",
        "ball-save": "ball-save 0.6s ease-out",
      },
    },
  },
